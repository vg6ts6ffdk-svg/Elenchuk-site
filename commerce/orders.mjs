...
export function createOrderSnapshot({id,customerType='b2c',lines,currency='RUB',goodsSubtotalMinor,idempotencyKey}){
 ...
 return Object.freeze({id,customerType,currency,goodsSubtotalMinor,lines:Object.freeze(snapshot),status:'draft',paymentStatus:'not_started',idempotencyKey,createdAt:new Date().toISOString()});
}
