...
// Only this fixed generated directory is replaced, never the source tree or data directory.
...
console.log(`Built ${publicFiles.length} public files in dist. API: ${url.origin}`);
